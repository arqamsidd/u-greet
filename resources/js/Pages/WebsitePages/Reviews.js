    ...
    return (
        <div>
            ...
            <div className="main-container">
                <section
                    className="imagebg image--dark cover cover-blocks bg--secondary"
                    data-overlay={3}
                >
                    <div className="background-image-holder hidden-xs">
                        <img
                            alt="background"
                            src="/assets/img/dropdown-1.jpg"
                        />
                    </div>
                                                ...
                                                <div className="testimonial row justify-content-center">
                                                    ...
                                                    <div className="col-lg-7 col-md-8 col-12">
                                                        <span className="h3">
                                                            ...
                                                            the video at his
                                                            celebration of life
                                                            which allowed us all
                                                            to deeply connect
                                                            with my Dad one last
                                                            time. I’m grateful
                                                            for U-Remember as
                                                            these memories would
                                                            have otherwise been
                                                            lost forever.
                                                        </span>
                                                        <h5>Marguerite</h5>
                                                ...
                                                <div className="testimonial row justify-content-center">
                                                    ...
                                                    <div className="col-lg-7 col-md-8 col-12">
                                                        <span className="h3">
                                                            ...
                                                            She was so blown
                                                            away with this
                                                            unique proposal that
                                                            she was saying,
                                                            “Yes” before I could
                                                            even get down on one
                                                            knee.
                                                        </span>
                                                        <h5>Lucas</h5>
                                                        <span>I-Loved</span>
