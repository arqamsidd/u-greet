            ...
            <div className="main-container">
                ...
                >
                    <video autoPlay loop muted>
                        <source
                            src="/assets/video/u-rem.mp4"
                            type="video/mp4"
                        />
                    </video>
                    <div className="background-image-holder">
                        <img alt="image" src="/assets/video/u-rem.jpg" />
                    </div>
                    <style
                                ...
                                >
                                    <ul className="slides">
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/urem-1.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/urem-2.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/urem-3.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/urem-4.png"
                                            />
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-12 col-lg-10">
                                <h2>
                                    Love is how you stay alive, even after you
                                    are gone.
                                </h2>
                                <h3>- Mitch Albom</h3>
                                <p className="lead">
                                    Cherish and honour your loved one's journey
                                    through a collaboration of memories,
                                    stories, pictures and messages captured in a
                                    timeless celebration of life tribute.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-7 col-6">
                                <Link to="#" className="block">
                                    ...
                                    >
                                        <video autoPlay loop muted>
                                            <source src="/assets/video/urem-4.mp4" />
                                        </video>
                                        <div className="background-image-holder">
                                            <img alt="image" src="/assets/#" />
                                        </div>
                        ...
                        <div className="row justify-content-around">
                            <div className="col-md-4 col-lg-3">
                                <h4>
                                    ...
                                    not to die. A U-Remember is an intimate
                                    celebration of life, an incredible tribute,
                                    and we hope an instrumental part of your
                                    healing journey.
                                </h4>
                                <p className="lead">
                                    U-Remember will capture the love and
                                    memories from your heart in a timeless,
                                    priceless, and easy to make video memorial.
                                    A collection of photos, stories and an
                                    outpouring of love is transformed into a
                                    beautiful legacy to cherish for many years
                                    to come.
                                </p>
                                <br />
                            </div>
                            <div className="col-md-4 col-lg-4 border--round mt--2">
                                <img
                                    ...
                                    src="/assets/img/vert_uremember.jpg"
                                />
                            </div>
                            <div className="col-md-4 col-lg-3">
                                <hr className="short" />
                                ...
                                <div className="checklist">
                                    <ol>
                                        <li>
                                            Create a celebration of life tribute
                                        </li>
                                        <li>
                                            View video at memorial or funeral
                                        </li>
                                        <li>Use as a video guestbook</li>
                                        <li>Build a video family tree</li>
                                ...
                                Sue and Donna{" "}
                                <img src="/assets/img/ribbon.png" width={30} />
                            </div>
                        </div>
                    </div>
                </section>
