            ...
            <div className="main-container">
                ...
                >
                    <video autoPlay loop muted>
                        <source
                            src="/assets/video/uWedMain.mp4"
                            type="video/mp4"
                        />
                    </video>
                    <div className="background-image-holder">
                        <img alt="image" src="/assets/U-Wed-2.html" />
                    </div>
                    <style
                                ...
                                >
                                    <ul className="slides">
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/uwed-1.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/uwed-2.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/uwed-3.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/uwed-4.png"
                                            />
                                        </li>
                                        <li>
                                            <img
                                                alt="Image"
                                                src="/assets/img/uwed-5.png"
                                            />
                                        </li>
                                    </ul>
                                </div>
                                <h3>Be a part of their happily ever after.</h3>
                                <Link
                    ...
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-10 col-lg-8">
                                <h2>
                                    Curated wedding greetings, tailored to you.
                                </h2>
                                <p className="lead">
                                    U-Wed captures the journey, love story and
                                    special moments of the newlywed couple
                                    gifting them with an unforgettable time
                                    capsule that celebrates them.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-7 col-6">
                                <Link to="#" className="block">
                                    ...
                                    >
                                        <video autoPlay loop muted>
                                            <source src="/assets/video/uwed4.mov" />
                                        </video>
                                        <div className="background-image-holder">
                                            <img alt="image" src="/assets/#" />
                                        </div>
                    ...
                    <div className="container">
                        <div className="row justify-content-around">
                            <div className="col-md-4 col-lg-3">
                                <h4>
                                    See your love story unfold through the eyes
                                    of your family and friends. Listen to them
                                    speak directly from the heart and share
                                    memories, stories and advice that will
                                    surely become the most sought-after gift
                                    registry item.
                                </h4>
                                <p className="lead">
                                    Whether the U-Wed is part of your wedding
                                    plan or is gifted to a couple you love, it
                                    is the ultimate wedding keepsake that - like
                                    your love story - will stand the test of
                                    time.
                                </p>
                            </div>
                            <div className="col-md-4 col-lg-4 border--round mt--2">
                                <img
                                    ...
                                    src="/assets/img/vert-uwed.jpg"
                                />
                            </div>
                            <div className="col-md-4 col-lg-3">
                                <hr className="short" />
                                <h3>Ways to Use U-Wed</h3>
                                <div className="checklist">
                                    <ul>
                                        <li>Wedding gift / registry item</li>
                                        <li>Live guestbook</li>
                                        <li>Fun RSVP option </li>
                                        <li>Unique Proposal </li>
