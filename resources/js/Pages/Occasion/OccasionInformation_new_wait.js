...
const OccasionInformation = () => {
    ...
    useEffect(() => {
        const reloadingData = sessionStorage.getItem("greetData_onReloading");
        if (reloadingData) {
            const reloading = JSON.parse(reloadingData);
            if (reloading?.id) {
                dispatch({
            ...
            <div>
                ...
                <div className="navigation bg-white">
                    <div className="inner inner-occasion inner-action">
                        <div className="left link" onClick={() => navigate("/dashboard")}>
                            <img
                            ...
                            <div className="text-text">
                                <div className="card-head color-white">
                                    <div className="font-20 bold">
                                        ...
                                        <span> on {greetData?.occasion_date}</span>
                                    </div>
                                </div>
                                <button
                                    onClick={() =>
                        ...
                        <div className="double-container">
                            ...
                            <div>
                                <div className="card-round bg-white theme-music">
                                    <div className="font-17 bold card-head">Add Themes</div>
                                    <div className="item">
                                        <div className="text d-flex">
                                            ...
                                            <div>
                                                <div className="font-14 semi-bold">Video Theme</div>
                                                <div className="color-2">
                                                    Current Theme: {greetData?.greet_theme?.name}
                                                </div>
                                            </div>
                                        </div>
                                        <button
                                            onClick={() => navigate("/occasionThemes")}
                                    ...
                                    <div className="item">
                                        <div className="text d-flex">
                                            ...
                                            <div>
                                                <div className="font-14 semi-bold">Music Theme</div>
                                                <div className="color-2">
                                                    Current Music: {greetData?.greet_music?.name}
                                                </div>
                                            </div>
                                        </div>
                                        <button
                                            onClick={() => navigate("/occasionMusic")}
                                            className="bg-3 bold btn2 d-flex justify-content-center align-items-center"
                                            style={{
                                                minWidth: "200px",
                                                maxHeight: "50px",
                                    ...
                                    <div className="item">
                                        <div className="text d-flex">
                                            ...
                                            <div>
                                                <div className="font-14 semi-bold">Transitions</div>
                                                <div className="color-2">
                                                    Current Transition: {greetData?.greet_transition?.name}
                                                </div>
                                            </div>
                                        </div>
                                        <button
                                            onClick={() => navigate("/occasionTransition")}
                                            className="bg-3 bold btn2 d-flex justify-content-center align-items-center"
                                            style={{
                                                minWidth: "200px",
                                                maxHeight: "50px",
                                ...
                                <div className="card-round bg-18">
                                    ...
                                    />
                                    <div className="text-text">
                                        <div className="font-20 bold card-head color-white">Invite People</div>
                                        <button
                                            onClick={() => {
                                ...
                                >
                                    ...
                                    <div className="text-text">
                                        ...
                                        <button
                                            onClick={() => navigate("/occasionPreview")}
                                            className="bg-3 bold"
                                        >
                                ...
                                <div className="card-round bg-black">
                                    ...
                                    <div className="text-text">
                                        ...
                                        <button
                                            className="bg-3 bold"
                                            onClick={() => navigate("/occasionCheckout")}
                                        >
                        ...
                        <div className="invite-popup">
                            ...
                            <div className="container">
                                <div className="inner">
                                    ...
                                    />
                                    <div className="title font-30 bold">Time to invite!</div>
                                    <div>Share this link with people to invite them to upload their videos and photos</div>
                                    <div className="link">https://link.to/share/this.kljkjl/lj</div>
                                    <div className="social">
                                        ...
                                        <div className="tab">
                                            <img
                                                ...
                                                alt="link"
                                            />
                                            <div className="font-10">Copy Link</div>
                                        </div>
                                        <div className="tab">
                                            <img
