    ...
    <div class="authentication admin">
        ...
        <div class="left">
            <div class="container">
                <div class="content">
                    <div class="head">
                        <div class="font-26 bold head">Welcome to U-Greet Admin Panel</div>
                    </div>
                    <form method="post" action="{{ route('post_login') }}">
                        ...
                        <div class="item">
                            <div class="text-input full-input">
                                ...
                                <input type="email" name="email" id="emailaddress" required="" class="bg-2 bg-2-fx" value=""
                                       autocomplete="off">
                        ...
                        <div class="item">
                            <div class="text-input full-input">
                                <div class="label bold">
                                    ...
                                    <a class="link" href="{{ ADMIN_BASE_URL.'forgot-password' }}" >
                        ...
                        <div class="item">
                            <button type="submit" class="bg-3 bold button-item" >Sign In
                            </button>
                        </div>
                        <br>
