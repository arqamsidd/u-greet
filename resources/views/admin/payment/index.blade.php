    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="{{route('occasions.alloccasions',$paymentData->user_id)}}">Occasions</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <input type="hidden" name="greet_id" value="{{$greetid}}" id="greet_id">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#payment-responsive-datatable').DataTable({
                ...
                order: [[0, 'ASC']],
                ajax: {
                    url: "{{route('useroccasions.allpayment')}}",
                    type: 'GET',
                    data: function (d) {
                        d.id = $('#greet_id').val();                                                                                                 
                    }
